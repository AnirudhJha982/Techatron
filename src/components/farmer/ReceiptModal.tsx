      ...
      <div className="relative w-full max-w-4xl max-h-[92vh] flex flex-col bg-white rounded-xl shadow-2xl overflow-hidden border border-slate-200">
        ...
        <div className="flex items-center justify-between px-5 py-3.5 bg-slate-900 text-white border-b border-slate-800">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-sm font-bold tracking-tight">Official Procurement Receipt Preview</h3>
              <p className="text-[11px] text-slate-400">Token Pass: {receipt.tokenNumber} • Mandi Marg Portal</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <Button
              ...
              size="sm"
              variant="outline"
              className="bg-slate-800 hover:bg-slate-700 text-slate-100 border-slate-700 text-xs font-bold h-8"
            >
              📥 Download File
            </Button>
            <Button
              onClick={handlePrint}
              size="sm"
              className="bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold h-8 shadow-sm"
            >
              🖨️ Print / Save as PDF
            </Button>
            <button
              onClick={onClose}
              className="p-1.5 ml-2 text-slate-400 hover:text-white rounded-lg hover:bg-slate-800 transition"
              title="Close modal"
            >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-8 bg-slate-100/70">
          <div className="bg-white border-2 border-emerald-700 rounded-lg p-6 sm:p-8 shadow-sm max-w-3xl mx-auto text-slate-900">
        ...
        <div className="flex items-center justify-between px-5 py-3 bg-slate-50 border-t border-slate-200">
          <p className="text-xs text-slate-500">
            Click <strong>Print / Save as PDF</strong> to generate an instant printable document.
          </p>
          <div className="flex space-x-2">
            <Button onClick={onClose} variant="outline" size="sm" className="text-xs">
              Close
            </Button>
            <Button onClick={handleDownload} variant="outline" size="sm" className="text-xs font-bold bg-white">
              📥 Download File
            </Button>
            <Button onClick={handlePrint} size="sm" className="bg-emerald-700 hover:bg-emerald-600 text-white text-xs font-bold">
              🖨️ Print / Save as PDF
            </Button>
          </div>
        </div>
